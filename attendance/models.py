...
class Sabha(models.Model):
    ...
    mandal = models.CharField(max_length=100, default='Default Mandal')
    xetra = models.CharField(max_length=100, default='Default Xetra')
...
class UserProfile(models.Model):
    ...
    def __str__(self):
        return f"{self.user.username} - {self.allowed_sabha_types}"